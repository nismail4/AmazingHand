...
class AHJoyTeleop:
    ...
    def run_AH_command(self):
        ...
        try:
            ...
            try:
                ...
                #     CloseHand(2)
                if self.current_command == "open_hand":
                    if self.current_hand_used == "right":
                        ...
                        OpenHand(1)
                        OpenHand(2)
                elif self.current_command == "close_hand":
                    if self.current_hand_used == "right":
                        CloseHand(1)
                    elif self.current_hand_used == "left":
                        CloseHand(2)
                        ...
                        CloseHand(1)
                        CloseHand(2)
                elif self.current_command == "clench":
                    if self.current_hand_used == "right":
                        ClenchHand(1)
                    elif self.current_hand_used == "left":
                        ClenchHand(2)
                    ...
                    if self.current_hand_used == "right":
                        ...
                        SpreadHand(1)
                        SpreadHand(2)
                elif self.current_command == None:
                    pass
                else:
    ...
    def move_fingers(self, posX, posY):
        if self.current_hand_used == "right":
            FlexionExtension(posX, 1, self.current_finger_used)
            AbductionAdduction(posY, 1, self.current_finger_used)
        elif self.current_hand_used == "left":
            FlexionExtension(posX, 2, self.current_finger_used)
            AbductionAdduction(posY, 2, self.current_finger_used)
        elif self.current_hand_used == "both":
            FlexionExtension(posX, 2, self.current_finger_used)
            FlexionExtension(posX, 1, self.current_finger_used)
            AbductionAdduction(posY, 2, self.current_finger_used)
